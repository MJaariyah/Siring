package com.codinginflow.siring.notif;
...
import com.codinginflow.siring.navigationdrawerexample.JadwalSholatFragment;
...
public class AppReceiver extends BroadcastReceiver {
    ...
    private void sendNotification(Context context, Intent itn) {
        ...
        Intent newIntent = new Intent(context, JadwalSholatFragment.class);
